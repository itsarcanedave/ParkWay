...
import 'package:parkway/ritzres.dart';
import 'package:parkway/reserve.dart';
class Ritz extends StatefulWidget {
  @override
  RitzState createState() {
    return new RitzState();
  }
}

String place = "Ritz-Carlton";

class RitzState extends State<Ritz> {
                  ...
                  children: <Widget>[
                    ...
                    new RaisedButton.icon(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => RitzRes()),
                        );
                      },
