...
class PlazaSenayanLoc extends StatefulWidget {
  @override
  PlazaSenayanLocState createState() {
    return new PlazaSenayanLocState();
  }
}
...
class PlazaSenayanLocState extends State<PlazaSenayanLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(plazaSenayanD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + plazaSenayanD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
