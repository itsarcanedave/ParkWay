...
class PlazaIndoLoc extends StatefulWidget {
  @override
  PlazaIndoLocState createState() {
    return new PlazaIndoLocState();
  }
}
...
class PlazaIndoLocState extends State<PlazaIndoLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(plazaIndoD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + plazaIndoD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
