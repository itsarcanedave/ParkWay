...
class Gambir extends StatefulWidget {
  @override
  GambirState createState() {
    return new GambirState();
  }
}

String place = "Gambir Station";

class GambirState extends State<Gambir> {
                  ...
                  children: <Widget>[
                    ...
                    new RaisedButton.icon(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => GambirRes()),
                        );
                      },
