...
class GambirLoc extends StatefulWidget {
  @override
  GambirLocState createState() {
    return new GambirLocState();
  }
}
...
class GambirLocState extends State<GambirLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(gambirD)) / 40 * 60;
    if (total == null) {
      total = 0;
    }
    return new Scaffold(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + gambirD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
