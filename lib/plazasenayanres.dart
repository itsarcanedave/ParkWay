...
class PlazaSenayanRes extends StatefulWidget {
  @override
  PlazaSenayanResState createState() {
    return new PlazaSenayanResState();
  }
}
...
class PlazaSenayanResState extends State<PlazaSenayanRes> {
  var price;
  var valet;
  var hours;
  var total;
