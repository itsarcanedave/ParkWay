...
import 'package:parkway/sencyres.dart';
import 'package:parkway/reserve.dart';
class Sency extends StatefulWidget {
  @override
  SencyState createState() {
    return new SencyState();
  }
}

String place = "Senayan City";

class SencyState extends State<Sency> {
                  ...
                  children: <Widget>[
                    ...
                    new RaisedButton.icon(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SencyRes()),
                        );
                      },
