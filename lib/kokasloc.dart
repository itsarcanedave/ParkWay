...
class KokasLoc extends StatefulWidget {
  @override
  KokasLocState createState() {
    return new KokasLocState();
  }
}
...
class KokasLocState extends State<KokasLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(kokasD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + kokasD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
