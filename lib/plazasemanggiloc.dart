...
class PlazaSemanggiLoc extends StatefulWidget {
  @override
  PlazaSemanggiLocState createState() {
    return new PlazaSemanggiLocState();
  }
}
...
class PlazaSemanggiLocState extends State<PlazaSemanggiLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(plazaSemanggiD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + plazaSemanggiD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
