...
class SencyLoc extends StatefulWidget {
  @override
  SencyLocState createState() {
    return new SencyLocState();
  }
}
...
class SencyLocState extends State<SencyLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  void getPostsData() async {
    ...
    sencyD = senayanCityDistance.toStringAsFixed(2);
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(sencyD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + sencyD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
