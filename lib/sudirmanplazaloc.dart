...
class SudirmanPlazaLoc extends StatefulWidget {
  @override
  SudirmanPlazaLocState createState() {
    return new SudirmanPlazaLocState();
  }
}
...
String plazaIndoD;
String plazaSemanggiD;
String plazaSenayanD;
String ritzD;
String sarinahD;
String suplazD;
var time = DateTime.now().millisecondsSinceEpoch.toString();

class SudirmanPlazaLocState extends State<SudirmanPlazaLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  void getPostsData() async {
    ...
    suplazD = sudirmanPlazaDistance.toStringAsFixed(2);
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(suplazD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + suplazD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
