...
class SudirmanPlazaRes extends StatefulWidget {
  @override
  SudirmanPlazaResState createState() {
    return new SudirmanPlazaResState();
  }
}
...
class SudirmanPlazaResState extends State<SudirmanPlazaRes> {
  var price;
  var valet;
  var hours;
  var total;
