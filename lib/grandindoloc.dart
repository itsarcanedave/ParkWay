...
class GrandIndoLoc extends StatefulWidget {
  @override
  GrandIndoLocState createState() {
    return new GrandIndoLocState();
  }
}
...
class GrandIndoLocState extends State<GrandIndoLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(grandIndoD)) / 40 * 60;
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + grandIndoD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
