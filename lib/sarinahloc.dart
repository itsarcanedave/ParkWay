...
class SarinahLoc extends StatefulWidget {
  @override
  SarinahLocState createState() {
    return new SarinahLocState();
  }
}
...
class SarinahLocState extends State<SarinahLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(sarinahD)) / 40 * 60;
    return new Scaffold(
      key: scaffoldKey,
      appBar: new AppBar(
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + sarinahD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
