...
class CitywalkLoc extends StatefulWidget {
  @override
  CitywalkLocState createState() {
    return new CitywalkLocState();
  }
}
...
class CitywalkLocState extends State<CitywalkLoc> {
  var price;
  var valet;
  var hours;
  var total;
  ...
  Widget build(BuildContext context) {
    ...
    cityTowerTime = (double.parse(citywalkD)) / 40 * 60;
    if (total == null) {
      total = 0;
    }
                ...
                Flexible(
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: " " + citywalkD + " kilometers away",
                      hintStyle: TextStyle(
                          fontSize: 20.0,
                          color: Colors.white,
                          fontFamily: 'Raleway'),
